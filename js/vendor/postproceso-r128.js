/* three.js r128 — post-proceso, copiado sin modificar de three@0.128.0/examples/js/ (licencia MIT).
   Contiene, en este orden: shaders/CopyShader.js, shaders/LuminosityHighPassShader.js,
   postprocessing/EffectComposer.js (define THREE.Pass y THREE.FullScreenQuad) y
   postprocessing/UnrealBloomPass.js. Lo usa functions.js §3C (Brillo). Local: no depende de internet. */
